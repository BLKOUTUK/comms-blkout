...
{ id: 'hub', keywords: ['hub', 'community', 'connect', 'blkouthub'] },
  ...
  { id: 'boroughs', keywords: ['borough', 'boroughs', 'local', 'map', 'london', 'near', 'nearby', 'brent', 'camden', 'croydon', 'enfield', 'hackney', 'haringey', 'lambeth', 'lewisham', 'newham', 'southwark', 'waltham', 'waltham forest', 'westminster', 'door', 'doors'] },
