...
// Canonical host (14 Sep 2026): comms.blkoutuk.cloud answers this app too. Page requests on
...
const CANONICAL_HOST = 'comms.blkoutuk.com';
const HOST_ALIASES = new Set(['comms.blkoutuk.cloud']);
