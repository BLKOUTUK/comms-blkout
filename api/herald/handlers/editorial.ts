 ...
 */
export async function handleSendEditorialPrompt(req: VercelRequest, res: VercelResponse) {
 ...
 */
export async function handleEditorialReply(req: VercelRequest, res: VercelResponse) {
