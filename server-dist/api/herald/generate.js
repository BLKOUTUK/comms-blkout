...
import { handleSendEditorialPrompt, handleEditorialReply, handlePreview, handleExport, handleSendFoxLists, handleSendFoxSend, handleAggregateIntelligence } from './handlers/index.js';
...
export default async function handler(req, res) {
    ...
    try {
        const spec = NEWSLETTER_SPECS[edition_type];
