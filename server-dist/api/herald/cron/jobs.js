...
export async function callAI(prompt, maxTokens = 1500) {
    if (!OPENROUTER_API_KEY)
        return '[Demo Mode] Content would be generated here';
 ...
 */
export async function runHeraldWeekly() {
 ...
 */
export async function runHeraldMonthly() {
    const intelligence = await fetchIntelligence();
 ...
 */
export async function runListenerResearch() {
    const intelligence = await fetchIntelligence();
    const snapshot = {
