...
async function curateEventsWithAI(searchResults) {
...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (APIFY_API_KEY) {
            ...
            try {
                const triggerResponse = await fetch(`${process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'https://comms-blkout.vercel.app'}/api/social-diary/apify-trigger`, {
                    method: 'POST',
